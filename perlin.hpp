//
// Created by Danny Le on 2022-10-06.
//

#ifndef UNTITLED_PERLIN_HPP
...
private:
    ...
    static double trilinear_interp(glm::dvec3 c[2][2][2], double u,  double v, double w) {
        auto uu = u*u*(3-2*u);
        auto vv = v*v*(3-2*v);
        auto ww = w*w*(3-2*w);
        auto accum = 0.0;
